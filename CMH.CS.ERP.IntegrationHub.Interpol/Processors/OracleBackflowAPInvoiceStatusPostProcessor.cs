...
namespace CMH.CS.ERP.IntegrationHub.Interpol.Biz
{
    ...
    /// </summary>
    public class OracleBackflowAPInvoiceStatusPostProcessor : IOracleBackflowPostProcessor<APInvoiceStatusMessage>
    {
        private readonly ILogger<OracleBackflowAPInvoiceStatusPostProcessor> _logger;
        private readonly IMessageProcessor _messageProcessor;
        private readonly IBUTrackerRepository _bUTrackerRepo;

        private const string STATUS_MSG_TYPE = "apinvoice";
        ...
        public OracleBackflowAPInvoiceStatusPostProcessor(
            ILogger<OracleBackflowAPInvoiceStatusPostProcessor> logger,
        ...
        /// <inheritdoc/>
        public int Process(IProcessingResultSet<APInvoiceStatusMessage> processingResults, IBusinessUnit businessUnit, DateTime lockReleaseTime, Guid processId)
        {
            var methodStopwatch = new Stopwatch();
            methodStopwatch.Start();

            var buDatatype = $"{ businessUnit.BUAbbreviation }.{ typeof(APInvoiceStatusMessage).Name.ToLower() }";
            ...
            try
            {
                ...
                var proccessedResults = processingResults.ProcessedItems
                    ...
                    .ToList<IRoutableItem<APInvoiceStatusMessage>>();
