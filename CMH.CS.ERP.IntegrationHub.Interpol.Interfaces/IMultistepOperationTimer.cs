...
namespace CMH.CS.ERP.IntegrationHub.Interpol.Interfaces
{
    public interface IMultistepOperationTimer
    {
        ...
        Task<T> RunTimedFunction<T1, T2, T3, T4, T>(Guid id, Func<T1, T2, T3, T4, Task<T>> func, T1 arg1, T2 arg2, T3 arg3, T4 arg4, string dataType, string businessUnit, TimeSpan criticalAlertLimit);
    }
}